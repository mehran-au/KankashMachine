...
function km_ui_strings(string $lang): array
{
    $fa = [
        ...
        'mail_from' => 'ایمیل ارسال پاسخ و تایید',
        'mail_from_name' => 'نام نمایشی فرستنده',
        'mail_reply_to' => 'Reply-To',
        'smtp_host' => 'SMTP host',
        'smtp_port' => 'پورت',
        'smtp_secure' => 'رمزنگاری',
        'smtp_user' => 'نام کاربری SMTP',
        'smtp_pass' => 'رمز SMTP',
        'smtp_pass_keep' => 'خالی بگذارید تا رمز فعلی حفظ شود.',
        'smtp_hint' => 'برای هاست DirectAdmin معمولاً mail.kankashmachine.com، پورت ۵۸۷ و TLS است. نام کاربری همان آدرس ایمیل صندوق است.',
        'test_email' => 'ارسال ایمیل آزمایشی',
        'test_sent' => 'ایمیل آزمایشی ارسال شد.',
        'test_failed' => 'ارسال آزمایشی ناموفق بود. هاست، پورت، کاربر و رمز را بررسی کنید.',
    ];
    $en = [
        ...
        'smtp_pass_keep' => 'Leave blank to keep the current password.',
        'smtp_hint' => 'On DirectAdmin this is usually mail.kankashmachine.com, port 587, TLS. Username is the mailbox address.',
        'test_email' => 'Send test email',
        'test_sent' => 'Test email sent.',
        'test_failed' => 'Test send failed. Check host, port, user and password.',
    ];
